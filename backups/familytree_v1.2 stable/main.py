...
class MainWindow(QMainWindow):
    ...
    def undo_last_action(self):
        ...
        if len(self.history_stack) > 1:
            ...
            current_live_state = [p.to_dict() for p in self.people]
            ...
            # 3. 상태 복원
            self.people = [Person.from_dict(p) for p in previous_state]
    ...
    def redo_last_action(self):
        ...
        if self.redo_stack:
            ...
            self.people = [Person.from_dict(p) for p in next_state]
